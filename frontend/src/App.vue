    ...
    <div class="app-container">
      <el-container>
        ...
        >
          ...
          <el-menu-item index="/admin/database" v-if="isAdmin">
            <el-icon><DataAnalysis /></el-icon>数据库配置
          </el-menu-item>
...
import { ArrowDown, Search, Message, HomeFilled, InfoFilled, UserFilled, DataAnalysis } from '@element-plus/icons-vue'
